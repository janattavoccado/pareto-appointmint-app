...
IMPORTANT RULES:
1. Be friendly AI Booking Assistant, professional, and concise
        ...
        if extracted.get('wants_reservation') or extracted.get('date') or extracted.get('time') or extracted.get('guests'):
            ...
            if res.date and res.time:
                ...
                if not valid:
                    res.date = None
                    res.time = None
                    return f"Welcome to {restaurant_name}! I'm the Batak´s AI booking assistant. I´d love to help you with a reservation. {error_msg} When would you like to visit us?"
