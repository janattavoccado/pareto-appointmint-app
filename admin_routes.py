...
# Add this route to your existing admin_routes.py file
# Place it with the other admin routes (after @admin_bp.route('/dashboard'))

@admin_bp.route('/pricing')
@admin_required
def pricing():
    """Display pricing and usage plans page."""
